<?php
/* The script pre_stage.php will be executed before the staging process begins. This will allow
 * users to prepare the environment for staging, for example validate and apply
 * any user provided parameter values, and verify the existence of some generic
 * prerequisites
